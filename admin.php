...
<html>
    ...
    <body>   
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header">
                <h1 class="animated lightSpeedIn">Panel de Control</h1>
        ...
        <?php
            $WhiteList=["ticketadmin","ticketedit","users","admin","config","stockadmin","stockedit","stock","productos","nuevoProducto","productocon","fichaje","fichajes","calendario"];

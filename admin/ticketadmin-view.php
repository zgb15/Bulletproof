<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, aquí podrá modificar los tickets existentes</p>
            </div>
          </div>
        </div>
            <?php
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="admin.php?view=ticketedit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>

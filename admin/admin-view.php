<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
                ...
                if(MysqlQuery::Eliminar("administrador", "id_admin='$id_admin'")){
                    echo '
                        <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                            ...
                            <p class="text-center">
                                El administrador fue eliminado del sistema correctamente
                            </p>
                        </div>
                    ';
                }else{
                    echo '
                        <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <h4 class="text-center">HA HABIDO UN ERROR</h4>
                            <p class="text-center">
                                El administrador no ha sido eliminado
                            </p>
                        </div>
                    ';
                } 
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
                <br><br>
              <p class="lead text-info">Bienvenido Admin., está viendo los usuarios y administradores de Bulletproof Prod.</p>
            </div>
          </div>
        </div>

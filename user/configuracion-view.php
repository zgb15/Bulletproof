        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-10 lead">
              ...
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta / <strong>eliminar tu cuenta</strong> permanentemente</p>
            </div>
          </div><!--Fin row well-->
          ...
          <div class="row">
            <div class="col-sm-8">
              <div class="panel panel-info">
                <div class="panel-heading text-center"><i class="fa fa-retweet"></i>&nbsp;&nbsp;<strong>Actualizar datos de mi cuenta</strong></div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label class="text-body"><i class="fa fa-user"></i>&nbsp;&nbsp;Nombre de usuario actual</label>
                    ...
                    <div class="form-group">
                      <label class="text-body"><i class="fa fa-key"></i>&nbsp;&nbsp;Contraseña actual</label>
              ...
              <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                      ...
                      <h4 class="modal-title text-center text-primary" id="myModalLabel">¿Quieres eliminar tu cuenta?</h4>
                    </div>
                    <form action="" method="post" role="form" style="padding:20px;">
                      <p class="text-info">Introduce usuario y contraseña</p>

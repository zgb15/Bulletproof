<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $fichaje_reg=MysqlQuery::RequestPost('fichaje_reg');
        
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave, fichaje", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg', '$fichaje_reg'")){
            ...
            echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        ERROR AL REGISTRARSE: Por favor vuelva a intentarlo.
                    </p>
                </div>
            '; 
        }
...
<div class="container">
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
              <label><i class="fa fa-key"></i>&nbsp;Clave Fichaje</label>
              <input type="text" class="form-control"  name="fichaje_reg"  placeholder="Escriba su clave de fichaje" required="">
            </div>
    ...
    <div class="col-sm-4 text-center hidden-xs">
      ...
      <h2 class="text-primary">Gracias por llegar hasta aquí, ¡registrándote obtendrás muchos privilegios!</h2>
    </div>

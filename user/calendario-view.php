<?php
include_once("./calendario/db.php");
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="color" class="form-control" id="color">
										...
										<option style="color:#0071c5;" value="#0071c5">Reunión</option>
										<option style="color:#FF4500;" value="#FF4500">Viaje</option>
										<option style="color:#8B4513;" value="#8B4513">Firma</option>	
										<option style="color:#A020F0;" value="#A020F0">Festivo</option>									
										<option style="color:#228B22;" value="#228B22">Presentación</option>
									</select>
								</div>
							</div>
							<div class="form-group">
